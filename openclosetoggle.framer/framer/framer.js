...
/***/ function(module, exports, __webpack_require__) {
	...
	var Screen, Utils, _, __domComplete, __domCompleteState, __domReady, _textSizeNode,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Layer = (function(superClass) {
	  ...
	  Layer.prototype._parentDraggableLayer = function() {
	    ...
	    ref = this.superLayers().concat(this);
	    for (i = 0, len = ref.length; i < len; i++) {
	      layer = ref[i];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SliderComponent = (function(superClass) {
	  ...
	  function SliderComponent(options) {
	    ...
	    this.knob.superLayer = this.fill.superLayer = this.knobOverlay.superLayer = this.sliderOverlay.superLayer = this;
...
/***/ function(module, exports) {
	...
	exports.date = 1451429128;
	
	exports.branch = "master";
	
	exports.hash = "209a50d";
